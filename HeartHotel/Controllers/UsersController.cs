...
namespace HeartHotel.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(EventisContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Password,Firstname,Lastname,Mobile,CreateDate,TelegramId,UpdateDate,Email,Position")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Password,Firstname,Lastname,Mobile,CreateDate,TelegramId,UpdateDate,Email,Position")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
